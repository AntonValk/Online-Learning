...
def run_trial(ex):
    ...
    if data_name == "a8a":
        if type == "trapezoidal" and n_neuron_aux_layer < 600:
            print(
                "For a8a dataset please set the number of neurons in aux layer to be more than or equal to 600"
            )
            exit()
        elif type == "variable_p" and n_neuron_aux_layer < 400:
            print(
                "For a8a dataset please set the number of neurons in aux layer to be more than or equal to 400"
            )
            exit()
    ...
    if model_to_run == "AuxDrop_ODL_DirectedInAuxLayer_RandomOtherLayer":
        if data_name in ["german", "svmguide3", "magic04", "a8a"]:
            model = AuxDrop_ODL_DirectedInAuxLayer_RandomOtherLayer(
                features_size=n_base_feat,
                max_num_hidden_layers=max_num_hidden_layers,
                qtd_neuron_per_hidden_layer=qtd_neuron_per_hidden_layer,
                n_classes=n_classes,
    ...
    if model_to_run == "AuxDrop_ODL_RandomAllLayer":
        if data_name in ["german", "svmguide3", "magic04", "a8a"]:
            model = AuxDrop_ODL_RandomAllLayer(
                features_size=n_base_feat,
                max_num_hidden_layers=max_num_hidden_layers,
                qtd_neuron_per_hidden_layer=qtd_neuron_per_hidden_layer,
                n_classes=n_classes,
    ...
    if model_to_run == "AuxDrop_ODL_RandomInAuxLayer":
        if data_name in ["german", "svmguide3", "magic04", "a8a"]:
            model = AuxDrop_ODL_RandomInAuxLayer(
                features_size=n_base_feat,
                max_num_hidden_layers=max_num_hidden_layers,
                qtd_neuron_per_hidden_layer=qtd_neuron_per_hidden_layer,
                n_classes=n_classes,
    ...
    if model_to_run == "AuxDrop_ODL_RandomInFirstLayer_AllFeatToFirst":
        if data_name in ["german", "svmguide3", "magic04", "a8a"]:
            model = AuxDrop_ODL_RandomInFirstLayer_AllFeatToFirst(
                features_size=n_base_feat,
                max_num_hidden_layers=max_num_hidden_layers,
                qtd_neuron_per_hidden_layer=qtd_neuron_per_hidden_layer,
                n_classes=n_classes,
